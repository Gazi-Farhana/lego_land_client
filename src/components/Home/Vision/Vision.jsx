const Vision = () => {
    return (
        <div>
            <div className="hero min-h-[600px]" style={{ backgroundImage: 'url(assets/images/unicef.jpg)' }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md text-black">
                        ...
                        <a href="https://www.dailymaverick.co.za/article/2019-10-15-poor-diets-are-damaging-childrens-health-unicef-warns/" className="btn btn-primary" target="_blank" rel="noreferrer">Unicef</a>
                    </div>
                </div>
            </div>
        </div>
